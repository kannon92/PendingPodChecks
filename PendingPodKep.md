...
- Consolidate configuration errors to a condition that controllers can use to determine errors
- Add a potential new container status before Waiting
- 
<!--
